  ...
  private func setupCoordinators() {
    ...
    for i in 0..<tabs.count {
      ...
      case .structure:
        ...
        structureCoordinator.rootViewController.tabBarItem = UITabBarItem(title: "My Habits", image: UIImage(systemName: "rectangle.stack.badge.plus"), tag: i)
        viewControllers.append(structureCoordinator.rootViewController)
      case .settings:
        let settingsCoordinator = SettingsCoordinator()
        childCoordinators.append(settingsCoordinator)
        settingsCoordinator.rootViewController.tabBarItem = UITabBarItem(title: "Settings", image: UIImage(systemName: "gearshape.fill"), tag: i)
